...
> виджету со WordCard — `🗑 [1] [2] [3] [4] ✓`. Уровень `0` — системный
> (присваивается при авто-создании item, руками не ставится; при `confidence=0`
> ни одна пилюля не подсвечена), `5` — внутренний потолок SRS (FLQ-7).
